...
var aText = new Array(
 ...
 "Em có nụ cười thật toả nắng, đôi mắt long lanh, một vẻ đẹp tri thức nó thu hút a đến kỳ lạ." ,
  ...
  "May sao rồi a cũng có cơ hội nói chuyện với em nhiều hơn. Anh cảm thấy sự đồng điệu ở chúng ta, a có một niềm tin rằng em mà mảnh ghép cuối cùng mà a đang tìm kiếm.",
  ...
  "Anh phải làm sao đây, làm thế nào để em tin rằng trên thế giới này vẫn còn tồn tại về cái gọi tình yêu. Hãy cho a cơ hội để cho em thấy nhé. Nhi à, anh muốn hỏi em một câu rằng liệu em có chút rung động nào với anh chưa?",
  "Anh tin rằng sự gặp gỡ của chúng ta không phải là ngẫu nhiên ! Đó như một thông điệp mà vũ trụ đang dẫn dắt chúng ta đến với nhau. Mình hãy nắm bắt lấy cơ hội này nhé" ,
  ...
  "Nhi à, A hy vọng chúng ta có thể tìm hiểu về nhau nhiều hơn. A cũng hy vọng chúng ta có một cái kết thật đẹp. Cùng nhau đi ăn,đi chơi, đi dạo chung , cùng nhau khám phá thế giới này nữa. ",
