...
var aText = new Array(
 ...
 "Em có nụ cười thật xinh, đôi mắt long lanh với cái mắt kính xinh sắn nó thu hút a đến kỳ lạ. " ,
  ...
  "Dược biết cô gái này vẫn available, lòng a vui quá chừng và một ngày nọ anh mạnh dạn thả tim trên story của em và may mắn thay được em reply lại. ",
  "Những ngày đầu nhắn tin với Hằng đúng nghĩa Hằng bơ luôn. Cả ngày chỉ có 2, 3 tin nhắn rầu Hằng lại còn ngủ sớm nữa chứ. ",
  "May sao rầu a cũng có cơ hội nói chuyện với Hằng nhiều hơn. Rồi a cũng biết Hằng nhiều hơn , chúng ta cũng có nhiều điểm chung với nhau rồi cùng quan điểm sống với nhau nữa.",
  ...
  "Nhớ em mong em, cả ngày chỉ nhìn cái điện thoại nhưng mãi không thấy được gì cả. Anh là gì với em, Hằng ơi! Em có chút rung động nào với anh chưa?",
  ...
  "Hằng à, A hy vọng chúng ta có thể tìm hiểu về nhau nhiều hơn. A cũng hy vọng chúng ta là một cặp nữa. Cùng nhau học chung, chơi chung, đi dạo chung , cùng nhau khám phá thế giới nữa. ",
  "A muốn làm nhiều thứ cùng với nhau, Hằng mở lòng đón nhận a nhé. A ước một ngày sớm nhất có thể gặp Hằng. ",
